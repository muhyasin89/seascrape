    ...
    <div class="col-lg-11">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                {{ Form::date('year', Input::old('year'), array('class' => 'form-control')) }}
            </div>
        <div class="form-group">
            ...
            <div class="form-group">
                {{ Form::label('vesels', 'Vesel') }}
                {{ Form::text('vesels', Input::old('vesels'), array('class' => 'form-control')) }}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                {{ Form::text('wrov', Input::old('wrov'), array('class' => 'form-control')) }}
            </div>
        <div class="form-group">
