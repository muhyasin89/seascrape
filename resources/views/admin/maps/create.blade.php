...
@section('content')
    <div class="col-lg-11">
        ...
        @endif
        {{ Html::ul($errors->all()) }}
        {{ Form::open(array('url' => 'admin/maps', 'files' => true)) }}
        ...
        <div class="form-group">
            ...
            {{ Form::textarea('maps', Input::old('maps'), array('class' => 'form-control')) }}
        </div>
        <div class="form-group">
            {{ Form::label('description', 'Description') }}
            {{ Form::textarea('description', Input::old('description'), array('class' => 'form-control')) }}
        </div>
        {{ Form::submit('Create Maps!', array('class' => 'btn btn-primary')) }}
        {{ Form::close() }}
    </div>
