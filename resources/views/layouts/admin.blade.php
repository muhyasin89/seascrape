        ...
        <div class="row">
            <div class="col-md-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="{{ url('admin/client/model') }}">Client Model</a></li>
                    <li><a href="{{ url('admin/subscriber') }}">Subscriber</a></li>
                    <li><a href="#">Work History</a></li>
                    <li><a href="{{ url('admin/about/core') }}">About -Core Value</a></li>
                    <li><a href="{{ url('admin/about/management') }}">About -Key Management</a></li>
                    <li><a href="{{ url('admin/service/equipment') }}">Services -Equipment</a></li>
